...
!(function (n, t) {
  ...
  var fn = {
    ...
    vn = { R: 0, P: 0, slides: [], C: [], F: null, N: null, B: !1, I: !1, H: !1, W: !1, V: !1, U: void 0, _: void 0, K: !1, G: !0, q: "none", Y: "none", X: !1, J: !1, Z: !0, nn: 0, tn: w(), en: !1, on: {}, scrollY: 0, scrollX: 0 };
  function dn(n) {
    Object.assign(vn, n);
  }
  function hn() {
  ...
  function ht(n) {
    var t,
      e,
      i = tt();
    return i.autoScrolling && !i.scrollBar ? ((t = -n), (e = p(bn)[0])) : ((t = n), (e = window)), { options: t, element: e };
  }
  function pt(n, t) {
  ...
  function St(n) {
    ...
    else if (tt().autoScrolling && !tt().scrollBar) y(nt(), { top: -t + "px" }), (s.test.top = -t + "px");
    else {
      var e = ht(t);
  ...
  function kt(n, t, e, i) {
    ...
    dn({ K: !0 }),
      ...
      (Mt = function (s) {
        ...
        if (vn.K) {
          var v = t;
          e && (v = o.fp_easings[tt().easing](f, a, u, e)), f <= e && pt(n, v), f < e ? window.requestAnimationFrame(Mt) : void 0 === i || l || (i(), dn({ K: !1 }), (l = !0));
  ...
  function jt(n, t) {
    var e = (function (n, t) {
      var e = {
        ...
        onLeave: function () {
          return { origin: Et(t.items.origin), destination: Et(t.items.destination), direction: t.direction, trigger: hn().N };
        },
        afterLoad: function () {
          return e.onLeave();
        },
        afterSlideLoad: function () {
          return { section: Et(t.items.section), origin: Et(t.items.origin), destination: Et(t.items.destination), direction: t.direction, trigger: hn().N };
        },
        ...
        onScrollOverflow: function () {
          return { section: Et(hn().F), hn: Dt(hn().F.activeSlide), position: t.position, direction: t.direction };
        },
      };
      return e[n]();
    })(n, t);
  ...
  function Nt(n, t, e) {
    var i = "";
    tt().anchors.length && !tt().lockAnchors && (n ? (null != e && (i = e), null == t && (t = n), dn({ _: t }), Bt(i + "/" + t)) : null != n ? (dn({ _: t }), Bt(e)) : Bt(e)), zt();
  }
  function Bt(n) {
  ...
  function Kt() {
    var n = F(this, En);
    m(this, Gn) ? _t().m.left && (dn({ N: "slideArrow" }), fn.L("moveSlideLeft", { section: n })) : _t().m.right && (dn({ N: "slideArrow" }), fn.L("moveSlideRight", { section: n }));
  }
  function Gt() {
    clearTimeout(Wt);
  }
  function qt(n, t, e) {
    var i,
      ...
      l = { slides: n, destiny: t, direction: e, destinyPos: { left: t.offsetLeft }, slideIndex: u.index(), section: r, sectionIndex: a.index(), anchorLink: a.anchor, slidesNav: p(Vn, r)[0], slideAnchor: u.anchor, prevSlide: a.activeSlide.item, prevSlideIndex: a.activeSlide.index(), items: { section: a, origin: a.activeSlide, destination: u }, localIsResizing: vn.W };
    (l.pn = ((i = l.prevSlideIndex), (o = l.slideIndex), i == o ? "none" : i > o ? "left" : "right")),
      (l.direction = l.direction ? l.direction : l.pn),
      l.localIsResizing || dn({ G: !1 }),
      tt().onSlideLeave && !l.localIsResizing && "none" !== l.pn && Y(tt().onSlideLeave) && !1 === jt("onSlideLeave", l)
        ? dn({ H: !1 })
        : (D(t, An),
          j(W(t), An),
          Oe(),
          ...
          (function (n, t, e) {
            var i,
              o,
              r = t.destinyPos;
            if (((i = t.slidesNav), (o = t.slideIndex), tt().slidesNavigation && null != i && (j(p(xn, i), An), D(p("a", p("li", i)[o]), An)), dn({ scrollX: Math.round(r.left) }), tt().css3)) {
  ...
  function $t(n) {
    n.localIsResizing || (Y(tt().afterSlideLoad) && jt("afterSlideLoad", n), dn({ G: !0 }), Lt(n.destiny), fn.L("afterSlideLoads", n)), dn({ H: !1 });
  }
  function Qt(n, t) {
    Tt(0, "internal"), void 0 !== t && dn({ W: !0 }), qt(F(n, zn), n), void 0 !== t && dn({ W: !1 }), Tt(et().scrollingSpeed, "internal");
  }
  function Xt(n, t) {
  ...
  function Jt(n, t) {
    ...
    var e = hn().F.item;
    if (tt().autoScrolling && !tt().scrollBar) y(Ot, { overflow: "hidden", height: "100%" }), j(At, "fp-scrollable"), Xt(et().recordHistory, "internal"), y(nt(), { "-ms-touch-action": "none", "touch-action": "none" }), null != e && St(e.offsetTop);
    else if ((y(Ot, { overflow: "visible", height: "initial" }), D(At, "fp-scrollable"), Xt(!!tt().autoScrolling && et().recordHistory, "internal"), y(nt(), { "-ms-touch-action": "", "touch-action": "" }), null != e)) {
    ...
    if (null != i) {
      var o,
        ...
        a = (function (n) {
          ...
          return t > w() ? ((o || a) && "bottom" !== a) || (i = r) : (o || (vn.W && null == T(n))) && (i = r), dn({ nn: i }), i;
        })(i),
        u = { element: i, callback: t, isMovementUp: e, dtop: a, yMovement: mt(hn().F, i), anchorLink: n.anchor, sectionIndex: n.index(), activeSlide: n.activeSlide ? n.activeSlide.item : null, leavingSection: hn().F.index() + 1, localIsResizing: vn.W, items: { origin: hn().F, destination: n }, direction: null };
      if (!((hn().F.item == i && !vn.W) || (tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height")))) {
        ...
        tt().autoScrolling &&
          ...
          (function (n) {
            ...
            if ((dn({ q: "none", scrollY: Math.round(n.dtop) }), fn.L("onPerformMovement"), tt().css3 && tt().autoScrolling && !tt().scrollBar))
  ...
  function de(n) {
    dn({ B: !1 }),
      (function (n) {
        null != n.mn &&
          (n.isMovementUp ? B(p(En)[0], n.mn) : N(p(En)[hn().C.length - 1], n.mn),
          St(hn().F.item.offsetTop),
          (function () {
            for (var n = p(Pn), t = 0; t < n.length; t++) Qt(n[t], "internal");
          })(),
  ...
  function Se(n) {
    var t = n.item,
      e = n.Tn.length,
      i = n.index();
    !hn().F && n.isVisible && (D(t, An), Oe()), (ye = hn().F.item), tt().paddingTop && y(t, { "padding-top": tt().paddingTop }), tt().paddingBottom && y(t, { "padding-bottom": tt().paddingBottom }), void 0 !== tt().sectionsColor[i] && y(t, { "background-color": tt().sectionsColor[i] }), void 0 !== tt().anchors[i] && t.setAttribute("data-anchor", n.anchor), e || be(n);
  }
  ...
  var Te,
    Me = {
      ...
      jn: function (n) {
        Me.En(n).addEventListener("scroll", Me.Ln), n.addEventListener("wheel", Me.kn, { passive: !1 }), n.addEventListener("keydown", Me.kn, { passive: !1 });
      },
      Dn: function (n) {
      ...
      Ln:
        ...
        function (n) {
          ...
          (Te = t), Y(tt().onScrollOverflow) && jt("onScrollOverflow", { position: t, direction: e }), m(n.target, In) && vn.G && Me.Pn(e, n.target) && Me.Cn() && fn.L("onScrollOverflowScrolled", { direction: e });
        }),
    },
    Ae = null,
    xe = null;
      ...
      t > 1 &&
        (tt().controlArrows &&
          (function (n) {
            ...
            N(p(zn, t)[0], e), D(e, _n), D(e[0], Gn), D(e[1], "fp-next"), "#fff" !== tt().controlArrowColor && (y(p(Yn, t), { "border-color": "transparent transparent transparent " + tt().controlArrowColor }), y(p(qn, t), { "border-color": "transparent " + tt().controlArrowColor + " transparent transparent" })), tt().loopHorizontal || O(p(qn, t));
          })(n),
        tt().slidesNavigation &&
          (function (n) {
            var t = n.item,
  ...
  var ii,
    ...
    ci = 0,
    si = 0,
    fi = (o.PointerEvent && (ai = { down: "pointerdown", move: "pointermove" }), ai),
    vi = { Wn: "ontouchmove" in window ? "touchmove" : fi ? fi.move : null, Vn: "ontouchstart" in window ? "touchstart" : fi ? fi.down : null };
  function di(n) {
    ...
    if (hi(n)) {
      ...
      var r = Math.abs(ui - ci) > (o.innerHeight / 100) * tt().touchSensitivity,
        ...
        l = ui > ci ? "down" : "up";
      dn({ q: u ? (li > si ? "right" : "left") : l }), u ? !vn.H && a && (li > si ? _t().m.right && fn.L("moveSlideRight", { section: t }) : _t().m.left && fn.L("moveSlideLeft", { section: t })) : tt().autoScrolling && vn.G && r && ei(l);
    }
  }
  function hi(n) {
          ...
          if (
            ...
            if (l || (!t && u)) {
              ...
              var c = (function (n) {
                  ...
                  do {
                    (i = Pi(o.item)).length && (t = { Un: o, _n: i[n ? i.length - 1 : 0] }), (o = dt(o[e]()));
                  } while (o && 0 === i.length);
                  return t;
                })(l),
                s = c ? c.Un : null;
              if (s) {
                ...
                fn.L("onScrollPageAndSlide", { Kn: f.index() + 1, slideAnchor: s.un ? 0 : s.index() }), (ri = c._n), V(n);
              }
            }
          }
        })(n)
  ...
  function Fi(n) {
    n
      ...
      : (r.addEventListener ? (G("mousewheel", Ni, !1), G("wheel", Ni, !1), G("MozMousePixelScroll", Ni, !1)) : r.detachEvent("onmousewheel", Ni), nt().removeEventListener("mousedown", Bi), nt().removeEventListener("mouseup", Ii));
  }
  function Ni(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        ...
        if (hn().B) {
          if (e) {
            var o;
            if (!(i || (Xe("isNewKeyframe", "beyondFullpage") && _e.Bn()))) return (o = ht(rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight)).element.scrollTo(0, o.options), dn({ Hn: !1 }), V(t), !1;
            if (_e.Bn()) return (e = !1), dn({ Hn: !0 }), dn({ N: "wheel" }), qe(), V(t), !1;
          } else Xe("set", "beyondFullpage", 1e3);
          if (!i && !e) return !0;
        }
      })(nt(), n);
    if ((vn.J || dn({ X: !1, J: !0, q: "none" }), !_t().m.down && !_t().m.up)) return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
    if (tt().autoScrolling && !ii && !e) {
      ...
      var s = t - Ci;
      return (Ci = t), s > 200 && (zi = []), dn({ Y: c }), vn.G && an(zi, 10) >= an(zi, 70) && l && (dn({ N: "wheel" }), ei(a < 0 ? "down" : "up")), !1;
    }
  ...
  function Hi(n) {
    n
      ? (Fi(!0),
        (function () {
          if (vi.Wn && (a || l)) {
            tt().autoScrolling && (At.removeEventListener(vi.Wn, wi, { passive: !1 }), At.addEventListener(vi.Wn, wi, { passive: !1 }));
            var n = tt().touchWrapper;
            n.removeEventListener(vi.Vn, pi), n.removeEventListener(vi.Wn, di, { passive: !1 }), n.addEventListener(vi.Vn, pi), n.addEventListener(vi.Wn, di, { passive: !1 });
          }
        })())
      : (Fi(!1),
        (function () {
          if (vi.Wn && (a || l)) {
            tt().autoScrolling && (At.removeEventListener(vi.Wn, di, { passive: !1 }), At.removeEventListener(vi.Wn, wi, { passive: !1 }));
            var n = tt().touchWrapper;
            n.removeEventListener(vi.Vn, pi), n.removeEventListener(vi.Wn, di, { passive: !1 });
          }
        })());
  }
    ...
    Qi || (((tt().autoScrolling && !tt().scrollBar) || !tt().fitToSection) && no(w())),
          ...
          for (var n = 0; n < 4; n++)
            qi = setTimeout(function () {
              window.requestAnimationFrame(function () {
                tt().autoScrolling && !tt().scrollBar && (dn({ W: !0 }), Ki(vn.F.index() + 1), dn({ W: !1 }));
              });
            }, 200 * n);
      })(),
      (Qi = !0),
      ...
      (Gi = setTimeout(function () {
        !(function () {
          ...
          } else (e = w()), (i = b()), (vn.tn === e && $i === i) || (dn({ tn: e }), ($i = i), Zi(!0));
          var e, i;
          dn({ W: !1 });
        })(),
          (Qi = !1);
  ...
  function Zi(n) {
    if (!m(nt(), Tn)) {
      ...
      var a = hn().F.index();
      vn.B || (a && Ki(a + 1)), dn({ W: !1 }), Y(tt().afterResize) && n && tt().afterResize.call(nt(), o.innerWidth, o.innerHeight), Y(tt().afterReBuild) && !n && tt().afterReBuild.call(nt()), $(nt(), "afterRebuild");
    }
  }
  function no(n) {
    var t = "" === n ? "" : n + "px";
  ...
  function io() {
    if (!vn.V && !tt().lockAnchors) {
      ...
      t && t.length && ((t && t !== vn.U && !i) || o || (!vn.H && vn._ != e)) && fn.L("onScrollPageAndSlide", { Kn: t, slideAnchor: e });
    }
  }
  function oo(n) {
    var t = n.target;
  ...
  function ro(n) {
    dn({ N: "menu" }), !p(tt().menu)[0] || (!tt().lockAnchors && tt().anchors.length) || (V(n), fn.L("onMenuClick", { anchor: U(this, "data-menuanchor") }));
  }
  function ao(n) {
    var t = n.target;
    ...
    if (!vn.W && hn().F && (rn(hn().C), !hn().B && !hn().Hn && (!tt().autoScrolling || tt().scrollBar))) {
      ...
      if (((i = u), (o = hn().F.item.offsetTop), (r = o + w()), ("up" == i ? r >= H() + w() : o <= H()) && (m(hn().F.item, On) || (D(hn().F.item, On), j(W(hn().F.item), On))), (e = (t = f[l]).item), !t.isActive)) {
        ...
        var d,
          ...
          S = t.index() + 1,
          T = t.activeSlide,
          M = { F: p, sectionIndex: S - 1, anchorLink: y, element: e, leavingSection: g, direction: b, items: { origin: hn().F, destination: t } };
        T && ((h = T.anchor), (d = T.index())),
          vn.G && (D(e, An), j(W(e), An), Y(tt().beforeLeave) && fe("beforeLeave", M), Y(tt().onLeave) && jt("onLeave", M), Y(tt().afterLoad) && jt("afterLoad", M), Pt(p), Ct(e), Lt(e), ie(y, S - 1), tt().anchors.length && dn({ U: y }), Nt(d, h, y), Oe()),
          clearTimeout(uo),
  ...
  function ho() {
    var n,
      ...
      e = hn().F,
      i = hn().F.item;
    D(i, On), Ct(i), Zt(), Lt(i), (t = Ti((n = to()).section)), (n.section && t && (void 0 === t || t.index() !== A(ye))) || !Y(tt().afterLoad) || jt("afterLoad", { F: i, element: i, direction: null, anchorLink: e.anchor, sectionIndex: e.index(), items: { origin: hn().F, destination: hn().F } }), Y(tt().afterRender) && jt("afterRender");
  }
  function po(n, t) {
    void 0 !== t
      ? (t = t.replace(/ /g, "").split(",")).forEach(function (t) {
  ...
  function mo() {
    ke(),
      ...
      ot(),
      (function () {
        y(ln(nt(), "body"), { height: "100%", position: "relative" }), D(nt(), wn), D(xt, Mn), dn({ tn: w() }), j(nt(), Tn), Pe();
  ...
  function wo() {
    var n = tt().licenseKey;
    "" === tt().licenseKey.trim() ? (v("error", "Fullpage.js requires a `licenseKey` option. Read about it on the following URL:"), v("error", "https://github.com/alvarotrigo/fullPage.js#options")) : (tt() && vn.Yn) || r.domain.indexOf("alvarotrigo.com") > -1 ? n && n.length : (v("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"), v("error", "https://alvarotrigo.com/fullPage/pricing")),
      m(xt, Mn)
        ? v("error", "Fullpage.js can only be initialized once and you are doing it multiple times!")
        : (tt().continuousVertical && (tt().loopTop || tt().loopBottom) && ((tt().continuousVertical = !1), v("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
          ...
          !tt().continuousVertical || (!tt().scrollBar && tt().autoScrolling) || ((tt().continuousVertical = !1), v("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
  ...
  function bo(n, t) {
    var e;
    if (((At = p("body")[0]), (xt = p("html")[0]), (Ot = p("html, body")), !m(xt, Mn)))
      return (
        "touchWrapper",
          ...
          Yn:
            ...
            (u = (function (t) {
              ...
              return (
                ...
                (s += a(c)),
                { Qn: new Date(e + "T00:00"), Xn: e.split("-")[2] === 8 * (An.length - 2) + "", Jn: s }
              );
            })(t)),
            (u &&
    ...
    (s.destroy = function (n) {
      Jt(!1, "internal"),
        ...
        n &&
          ...
          y(nt(), { height: "", position: "", "-ms-touch-action": "", "touch-action": "" }),
